...
public class UpsConstants {
    public static final String XIAOMI_APP_ID = "XM_APP_ID";
    public static final String XIAOMI_APP_KEY = "XM_APP_KEY";
    public static final String MEIZU_APP_ID = "MZ_APP_ID";
    public static final String MEIZU_APP_KEY = "MZ_APP_KEY";
